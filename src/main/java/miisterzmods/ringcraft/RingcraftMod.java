package miisterzmods.ringcraft;
...
@Mod("ringcraft")
public class RingcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(RingcraftMod.class);
	public static final String MODID = "ringcraft";

	public RingcraftMod(IEventBus modEventBus) {
