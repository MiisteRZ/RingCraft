...
public class RingcraftModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<IceKingEntityEntity>> ICE_KING_ENTITY = register("ice_king_entity",
			EntityType.Builder.<IceKingEntityEntity>of(IceKingEntityEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).fireImmune().sized(0.8f, 1.4f));
