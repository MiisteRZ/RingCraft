...
public class RosaniForestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<RosaniForestTrunkDecorator> CODEC = MapCodec.unit(RosaniForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("ringcraft:rosani_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
