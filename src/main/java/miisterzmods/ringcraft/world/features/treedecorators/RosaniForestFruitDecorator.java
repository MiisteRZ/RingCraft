...
public class RosaniForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<RosaniForestFruitDecorator> CODEC = MapCodec.unit(RosaniForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("ringcraft:rosani_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public RosaniForestFruitDecorator() {
		super(0.2f);
	}
