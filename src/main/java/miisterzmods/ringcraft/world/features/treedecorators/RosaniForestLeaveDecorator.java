...
public class RosaniForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<RosaniForestLeaveDecorator> CODEC = MapCodec.unit(RosaniForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("ringcraft:rosani_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RosaniForestLeaveDecorator() {
		super(0.25f);
	}
